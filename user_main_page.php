...
<body>
    <div class="form">
        ...
        <div class="buttons">
            ...
            <button class="button" onclick="location.href='exchanges/exchanges-main.php'">Distribution of Exchanges</button>
            <button class="button" onclick="location.href='meal_plan/main.php'">Meal Plan</button>
        </div>
    </div>
